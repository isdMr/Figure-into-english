...
int y=n/1000;
n=n-y*1000;
if(y==1) s="one thousand ";
else if(y==2) s="two thousand ";
else if(y==3) s="three thousand ";
else if(y==4) s="four thousand ";
else if(y==5) s="five thousand ";
else if(y==6) s="six thousand ";
else if(y==7) s="seven thousand ";
else if(y==8) s="eight thousand ";
else if(y==9) s="nine thousand ";
...
t=n/10;
if(t==2)s=s+"twenty ";
else if(t==3)s=s+"thirty ";
else if(t==4)s=s+"forty ";
else if(t==5)s=s+"fifty ";
else if(t==6)s=s+"sixty ";
else if(t==7)s=s+"seventy ";
else if(t==8)s=s+"eighty ";
else if(t==9)s=s+"ninty ";
}
